...
function generate(title, docs, filename, filenames, resolveLinks) {
    ...
    if (members.globals.length) {
        ...
        members.globals.forEach(function(g) {
            if ( g.kind !== 'typedef' && !hasOwnProp.call(seen, g.longname) ) {
                globalNav += '<li>' + linkto('global', g.longname, g.name) + '</li>';
            }
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    //We'll save the generated file names for the Angular Module template
    var filenames = [];

    if (members.globals.length) { generate('Global', [{kind: 'globalobj'}], globalUrl, filenames); }
    ...
    view.layout = '';
    var outpath = path.join(outdir, 'jsdoc.js'),
        html = view.render('angularModule.tmpl', docData);
